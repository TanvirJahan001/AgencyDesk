/**
 * app/(dashboard)/employee/announcements/page.tsx
 *
...
import EmployeeAnnouncementsClient from "./EmployeeAnnouncementsClient";
...
export default async function EmployeeAnnouncementsPage() {
  ...
  return <EmployeeAnnouncementsClient initialAnnouncements={initialAnnouncements} />;
}
